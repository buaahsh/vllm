...
def test_deepseek_fp8_dispatch_uses_v41_config_on_cuda_alike():
    from vllm.model_executor.layers.quantization import get_quantization_config
    from vllm.platforms import current_platform

    if not (current_platform.is_cuda() or current_platform.is_rocm()):
        pytest.skip("V4.1 quantization dispatch requires CUDA or ROCm")
    from vllm.models.deepseek_v41 import DeepseekV4FP8Config

    assert get_quantization_config("deepseek_v4_fp8") is DeepseekV4FP8Config
