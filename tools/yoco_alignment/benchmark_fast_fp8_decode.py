...
"""Reproduce the single-GPU YOCO Fast FP8 warm-prefix decode measurement.

See docs/yoco/performance/FAST_FP8_DECODE_BENCHMARK.md for the timing scope.
This script uses the offline engine internals of the fhb-dev-9-18 branch.
"""
...
def main(
    *, precision: Literal["fp8", "bf16"] = "fp8", entrypoint: Path | None = None
    ...
    try:
        ...
        def generate(prompts, params, profile=None):
        ...
        for batch in args.batches:
            ...
            for _ in range(args.repeats):
                outputs, seconds = generate(prompts, params)
