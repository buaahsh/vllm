...
from vllm.model_executor.layers.yoco_ops.fp8 import silu_mul_quant_fp8_packed
...
class Fp8PerBlockOnlineLinearMethod(OnlineLinearBase):
    ...
    def supports_silu_mul_fusion(self) -> bool:
        ...
        from vllm.config.yoco import YOCO_FP8_GROUP_EPS
        ...
        return (
            ...
            and self.fp8_linear.config.group_quant_eps == YOCO_FP8_GROUP_EPS
    ...
    def apply_silu_mul(
        ...
        q_input, scale = silu_mul_quant_fp8_packed(gate_up, clamp_limit)
...
class _Fp8OnlineMoEBase(OnlineMoEMethodBase):
    ...
    def _setup_kernel(
        ...
        if self.moe_quant_config:
            ...
            if (
                layer.moe_config.yoco.fast_w13_config
                and not layer.moe_config.yoco.align_weighted_swiglu
            ):
