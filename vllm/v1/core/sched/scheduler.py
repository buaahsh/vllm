...
from vllm.v1.yoco_cache import yoco_remote_prefill_token_count
...
class Scheduler(SchedulerInterface):
    ...
    def _yoco_final_prompt_block_split(
        ...
        final_prompt_block_start = yoco_remote_prefill_token_count(
    ...
    def finish_requests(
        ...
        Returns:
            ...
            already finished.
        """
        requests, _ = self._finish_requests(request_ids, finished_status)
        return requests
    ...
    def finish_requests_with_kv_transfer_params(
        ...
        _, outputs = self._finish_requests(request_ids, finished_status)
        return outputs

    def _finish_requests(
        self, request_ids: str | Iterable[str] | None, finished_status: RequestStatus
    ) -> tuple[list[Request], list[tuple[str, int, dict[str, Any] | None]]]:
        ...
        for request in valid_requests:
            ...
            kv_transfer_params, _ = self._free_request(
        ...
        return valid_requests, finished_requests
